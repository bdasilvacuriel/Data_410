...
The main objective of this analysis is to identify predictors that significantly influence the chance of being diagnosed with Alzheimer's. We will also explore potential multicollinearity between predictors, as highly correlated variables can impact the model's performance and interpretation.
...
```{r Step.fwd.chisquared.tests, echo=FALSE}
...
kable(chi.results, 
  ...
  kable_styling(bootstrap_options = c("striped", "condensed", "responsive"), 
                full_width = FALSE) %>%
  column_spec(2, color = ifelse(chi.results$Deviance.Change == min(chi.results$Deviance.Change), "red","black")) %>%  # Make "Deviance Change" column bold
  column_spec(4, color = ifelse(chi.results$P.value > 0.05, "red", "black"))  # Highlight insignificant P-values
```
...
```{r Reduced.model.check, echo=FALSE, fig.align='center'}
## Fit reduced model
...
```{r Log.odds, include=FALSE}
#Calculate log-odds ratios of predictors in the GAM model to see which ones have the strongest change in odds of alzheimers diagnosis
